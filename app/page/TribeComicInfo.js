...
class TribeComicInfo extends React.Component{
    constructor(props){
        super(props);
    ...
    componentDidMount(){
        ...
        _CommentsActions.getComment({
            url:'/app/novel/'+this.props.params.comicId+'/comment/list',
            ...
            <Container scrollable className="tribe-novel">
                ...
                >
                    <div>
                        ...
                        <div>
                            <img src={this.props.location.query.comic} alt=""/>
                        </div>
