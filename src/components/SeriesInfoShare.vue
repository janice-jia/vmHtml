<template>
  <div class="seriesInfo">
    ...
    <div class="seriesDesc">
      <div class="seriesBtn"><a href="javascript:;" @click="downApp">观看更多视频点击打开众创部落</a></div>
      <div class="seriesInfo-tit">
        <p class="tit" style="font-weight: bold">{{videoDetails.title}}</p>
      ...
      methods: {
        ...
        downApp () {
          if (/(iPhone|iPad|iPod|iOS)/i.test(navigator.userAgent)) {  //判断iPhone|iPad|iPod|iOS
            ...
            window.location.href ="https://itunes.apple.com/cn/app/id1142109974?mt=8";
          } else if (/(Android)/i.test(navigator.userAgent)) {   //判断Android
            //alert(navigator.userAgent);
            window.location.href ="http://zhushou.360.cn/detail/index/soft_id/3392157";
          } else {  //pc
            window.location.href ="http://zhushou.360.cn/detail/index/soft_id/3392157";
          };
        },
