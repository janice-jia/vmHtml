...
class TribeVideo extends React.Component{
    ...
    render() {
        return <View>
            <_Header></_Header>
            <Group className={this.state.tribeVideoList.length>0 ? 'hidden' : 'null-con bgF margin-0'}>没有内容！</Group>
            <Container scrollable className={this.state.tribeVideoList.length>0 ? 'tribe' : 'hidden'}>
