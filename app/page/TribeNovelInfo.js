...
class TribeNovelInfo extends React.Component{
    constructor(props){
        super(props);
    ...
    componentDidMount(){
        ...
        _CommentsActions.getComment({
            url:'/app/novel/'+this.props.params.novelId+'/comment/list',
            ...
            <Container scrollable fill className="tribe-novel">
                ...
                >
                    <div>
                        ...
                        <div>
                            <iframe height="auto" width="100%" src={this.props.location.query.content} frameBorder="0"></iframe>
                        </div>
