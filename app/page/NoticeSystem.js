...
class NoticeSystem extends React.Component{
    ...
    render() {
        return <View>
            ...
            <Group className={this.state.noticeSystem.length>0 ? 'hidden' : 'null-con bgF margin-0'}>系统通知为空！</Group>
                ...
                >
                    <div style={{paddingBottom:'40px'}}>
                        <List className="comments margin-0 noticeList">
                            {this.state.noticeSystem.map((item, i) => {
                                return(
                                    <List.Item
